...
import com.example.placebit.util.ContextKeeper
...
class StringSetPref(defaultValue: Set<String> = setOf(), keyName: String? = null) : Pref<Set<String>>(defaultValue, keyName) {
    ...
    override fun SharedPreferences.getValue(key: String, default: Set<String>): Set<String> =
        this.getStringSet(key, default)!!
    override fun SharedPreferences.Editor.setValue(key: String, value: Set<String>): SharedPreferences.Editor = putStringSet(key, value)
}
...
class LongPref(defaultValue: Long = 0L, keyName: String? = null) : Pref<Long>(defaultValue, keyName) {
    ...
    override fun SharedPreferences.Editor.setValue(key: String, value: Long): SharedPreferences.Editor = putLong(key, value)
}
...
class FloatPref(defaultValue: Float = 0f, keyName: String? = null) : Pref<Float>(defaultValue, keyName) {
    ...
    override fun SharedPreferences.Editor.setValue(key: String, value: Float): SharedPreferences.Editor = putFloat(key, value)
}
...
class GsonListPref<T>(
    ...
    override fun SharedPreferences.Editor.setValue(key: String, value: List<T>): SharedPreferences.Editor {
        cachedObject = value
        putString(key, Gson().toJson(value) ?: return this)
        return this
    }
...
class BooleanMapPref(
    ...
    override fun SharedPreferences.Editor.setValue(key: String, value: HashMap<String, Boolean>): SharedPreferences.Editor {
        cachedObject = value
        putString(key, Gson().toJson(value) ?: return this)
        return this
    }
